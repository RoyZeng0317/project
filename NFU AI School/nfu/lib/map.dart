...
class _MapPageState extends State<MapPage> {
  ...
  Future<void> _initMap() async {
    await Future.wait([_loadCurrentLocation(), _loadParkingLots()]);
  }
  ...
  Future<List<LatLng>> _fetchDirections(
    ...
    if (status != 'OK') {
      throw data['error_message'] as String? ??
          'Google Directions API 回傳: $status';
    }
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          if (_isLoadingLots) const Center(child: CircularProgressIndicator()),
